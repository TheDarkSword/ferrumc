...
Output is `assets/extracted/<version>/entity_types.json`.
...
def main() -> None:
    ...
    out = REPO_ROOT / "assets" / "extracted" / args.version / "entity_types.json"
    ...
    print(f"{len(data['types'])} entity types -> {out.relative_to(REPO_ROOT)}")
